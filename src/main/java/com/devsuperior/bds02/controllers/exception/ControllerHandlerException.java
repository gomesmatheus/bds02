...
public class ControllerHandlerException {
	...
	@ExceptionHandler(ResourcecNotFoundException.class)
	public ResponseEntity<StandardError> resourceNotFound(ResourcecNotFoundException e, HttpServletRequest request) {
